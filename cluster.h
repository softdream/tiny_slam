...
private:
	const std::pair<typename sensor::ScanContainer<DataType>::type, DataType> getMaxDistAndMean( const std::vector<typename sensor::ScanContainer<DataType>::type>& cluster )
	{
